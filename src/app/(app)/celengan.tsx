...
export default function CelenganScreen() {
  const hasEntries = SAVINGS_ENTRIES.length > 0;
            ...
            <View className="items-center">
              ...
              <AppText weight="regular" className="text-white/90 text-base">
                <AppText weight="bold" className="text-lg">
                  {formatCurrency(SAVINGS_GOAL.current)}
                </AppText>{" "}
                dari{" "}
                <AppText weight="bold" className="text-yellow-300">
                  {formatCurrency(SAVINGS_GOAL.target)}
                </AppText>
              </AppText>
            </View>
          </LinearGradient>
          ...
          <View className="flex-1 px-5 pt-7 min-h-[400px]">
            ...
            {hasEntries ? (
              <>
                {/* Entries List */}
                <View className="mb-5">
                  {SAVINGS_ENTRIES.map((entry) => {
                    const iconData = getEntryIcon(entry.type);
                    return (
                      <View
                        key={entry.id}
              ...
              <>
                ...
                <View className="items-center py-10">
                  ...
                  <TouchableOpacity className="bg-sage py-3 px-8 rounded-full">
